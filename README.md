...
To fetch products data were used next links:
- [products](https://mate-academy.github.io/react_phone-catalog/api/products.json)
- [product details](https://mate-academy.github.io/react_phone-catalog/api/products/dell-streak-7.json)
...
CSS3 and SCSS preprocessor: grid layout, flexbox, positioning;
JavaScript,
React.

Preview links:

These tasks have been done during implementing the project:
