...
export const BannerSlider: React.FC = () => {
  ...
  return (
    <div className="banner">
      ...
      <div className="banner__pagination rectangle">
        {BannerImages.map((_, index) => (
          <button
            key={`rectangle-${index * BannerImages.length}`}
            aria-label="banner__pagination"
            type="button"
            className={classNames('rectangle__button', {
              'rectangle__button--active': index === currentIndex,
            })}
